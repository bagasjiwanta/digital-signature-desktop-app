...
def sign_binary_file(input_file_name: str, key_file_name: str, public_key: PublicKey):
...
def verify_binary_file(input_file_name: str, key_file_name: str, private_key: PrivateKey):
